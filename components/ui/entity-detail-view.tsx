...
export function EntityDetailView({
  ...
  return (
    <Card
      className={cn(
        "w-full max-w-4xl mx-auto overflow-hidden border-none shadow-2xl shadow-slate-200/50 dark:shadow-black/50",
        className,
      )}
    >
          ...
          {attachments.length > 0 && (
            <motion.div variants={itemVariants} className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                {onDownloadAll && (
                  <Button variant="ghost" size="sm" className="text-primary" onClick={onDownloadAll}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                {onAddAttachment && (
                  <div
                    className="flex items-center justify-center p-3 border-2 border-dashed rounded-lg cursor-pointer hover:bg-muted/40 transition-colors"
